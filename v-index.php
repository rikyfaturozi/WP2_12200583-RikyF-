<section>
    ...
    <p align='justify'>Pada pengertian CodeIgniter diatas tadi dijelaskan bahwa
         CodeIgniter menggunakan metode MVC apa itu MVC kita juga mengetahui
          apa itu MVC sebelum masuk dan lebih jauh dalam belajar codeigniter.</p>
    <p> MVC adalah teknik atau konsep yang memisahkan komponen yaitu model, view
        dan controller.</p>

        <ol type="a">
        <li>Model</li>
    <p align='justify' >model adalah kelas yang mempresentasikan atau memodelkan tipe data yang 
        yang akan digunakan oleh aplikasi.model juga dapat didefinisikan sebagai bagian penanganan 
        yang berhubungan dengan pengelolahan manipulasi database.seperti misalnya mengambil data 
